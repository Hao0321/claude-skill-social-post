...
**31 小時後實測數據**（FB 洞察報告，原作者 ~4K 粉帳號）：
- **瀏覽者 72,323 人 / 瀏覽次數 119,722 次**
- **358 讚 / 443 留言 / 73 分享**（互動率 15.3%）
- **+167 FB 追蹤者 / +700 Line 社群成員**
- **97% 觸及是非追蹤者** — 演算法廣推，不靠既有粉絲
- 留言/讚比超過 1.0 — CTA「留言我拉你入群」觸發大量入群

這個 repo 就是把那晚做出來的 skill 開源，給想用同樣方法經營自己社群的人。

> **v0.2 更新（2026-04-22）**：新增 Day 2 flop postmortem + 一天一篇鐵則 + 爆款節奏原則 + 基於實戰校準的 benchmark 表。詳見 [CHANGELOG.md](CHANGELOG.md)。
