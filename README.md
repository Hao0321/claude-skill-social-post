...
**72 小時後實測數據**（FB 洞察報告，原作者 ~4K 粉帳號，2026-04-24 量測仍在長尾擴散）：
- **瀏覽者 74,510 人 / 瀏覽次數 125,315 次**
- **374 讚 / 452 留言 / 80 分享**（互動率 15.3%）
- **+167 FB 追蹤者 / +1,150 Line 社群成員**（原 ~800→現 1,952）
- **96.7% 觸及是非追蹤者** — 演算法廣推，不靠既有粉絲
- **排名最近 10 篇第 1/10**，72h 後仍在漲 = evergreen 長尾內容

這個 repo 就是把那晚做出來的 skill 開源，給想用同樣方法經營自己社群的人。

> **v0.3 更新（2026-04-24）**：新增 6 個廣推公式（F8-F13）突破鐵粉圈 + FB 2026 演算法訊號權重 + 2026 高停留開頭 + 時段指南修正（AI/tech 創作者受眾是 22:00-01:00 夜貓時段而非 9-11AM）。詳見 [CHANGELOG.md](CHANGELOG.md)。
...
F6b 公式（meta-ship 變體）是 co-build 過程意外驗證的——「這篇 po 就是 skill 自己發的」這句懸念 31 小時內觸及 **72,323 人、358 讚、443 留言、73 分享、+700 Line 社群成員**。

Day 2 則記錄了完整的 flop postmortem — 連續用同公式 + 炫 Day 1 數字 + 排凌晨 02:16 = 只 15 讚。**失敗的資料跟成功一樣珍貴**。
